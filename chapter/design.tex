...
\subsubsection{ローパス・フィルター}

図\ref{fig:lpf_circuit}に示すように、DACの出口にあったキャパシターとインダクターからなるローパス・フィルターを排除した。もうひとつのチャンネルも同様である。
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=13cm]{figures/prop_line.pdf}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=10cm]{figures/eq_wire.pdf}
