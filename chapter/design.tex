...
実際の基板は、差動信号における対（たとえば、付録\ref{app:rhea_parts_sircuit}の差動信号「{\tt DAC\_\,P\_\,D1}」と「{\tt DAC\_\,N\_\,D1}」の対など）の等張配線は$\pm 1$ mmの精度である。また、対ではないが同種の信号線（たとえば、同付録のDACのデータ線「{\tt DAC\_\,P\_\,D1}」と「{\tt DAC\_\,P\_\,D2}」など）は$\pm 2$ mmの精度である。したがって、実際の基板における等張配線の精度は十分満足する。
