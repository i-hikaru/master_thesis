...
\begin{figure}[!h]
 ...
 \caption{分配したクロック信号をデバック用LEDを用いて評価する構成のブロック図}
...
RHEAには帯域を制限するLPF（ローパス・フィルター）が存在しないため、
より広い帯域が期待できる。
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=13cm]{figures/schem_linearity.pdf}
 \caption[線型性の評価方法]
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=14cm]{figures/setting_linearity.pdf}
 \caption[線型性評価の装置構成]
 {線型性評価の装置構成。
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=15.5cm]{figures/ACchar.png}
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=15cm]{figures/phase_std.png}
